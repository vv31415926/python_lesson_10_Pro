    ...
    def accept_cards(self):
        for i in range(self.gamers[self.main_gamer].get_count(), 6):
            if self.koloda.get_count() > 0:
                self.gamers[self.main_gamer].accept_cards(self.koloda.card_out())
        for i in range(self.gamers[self.slave_gamer].get_count(), 6):
            if self.koloda.get_count() > 0:
                self.gamers[self.slave_gamer].accept_cards(self.koloda.card_out())
    ...
    def start(self):
        ...
        for i in range(6):
            for i in range( len(self.gamers) ):
                self.gamers[i].accept_cards(self.koloda.card_out())
            ...
            if self.main_gamer == self.comp:  # ходит комп
                ...
                if len( self.card_in) > 0:  # был выбор
                    ...
                    if n > 0:  # был выбор
                        ...
                        self.gamers[self.slave_gamer].accept_cards(*self.table.get_cards())
